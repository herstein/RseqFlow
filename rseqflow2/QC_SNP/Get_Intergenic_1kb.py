...
def process_gene_model(sh_annotation,cds_exon,intron,utr_3,utr_5):
	intergenic_up_1kb = getIntergenic(sh_annotation,direction="up",size=1000)
        intergenic_down_1kb = getIntergenic(sh_annotation,direction="down",size=1000)

        print "merge integenic region"
        #merge integenic region
        intergenic_up_1kb=unionBed3(intergenic_up_1kb)
        intergenic_down_1kb=unionBed3(intergenic_down_1kb)

        print "purify intergenic region 1kb"
        #purify intergenic region
        intergenic_up_1kb=subtractBed3(intergenic_up_1kb,cds_exon)
        intergenic_up_1kb=subtractBed3(intergenic_up_1kb,utr_5)
        intergenic_up_1kb=subtractBed3(intergenic_up_1kb,utr_3)
        intergenic_up_1kb=subtractBed3(intergenic_up_1kb,intron)
        intergenic_down_1kb=subtractBed3(intergenic_down_1kb,cds_exon)
        intergenic_down_1kb=subtractBed3(intergenic_down_1kb,utr_5)
        intergenic_down_1kb=subtractBed3(intergenic_down_1kb,utr_3)
        intergenic_down_1kb=subtractBed3(intergenic_down_1kb,intron)

	return(intergenic_up_1kb,intergenic_down_1kb)
...
def main():
	...
	print "Processing BED file Done"
        (intergenic_up_1kb,intergenic_down_1kb) = process_gene_model(sh_annotation,cds_exon,intron,utr_3,utr_5)

	inter_up_1kb_OUT=open(options.output_prefix+".intergenic_up_1kb.txt",'w')
        for chrom,star,end in intergenic_up_1kb:
                print >>inter_up_1kb_OUT, "%s\t%s\t%s" % (chrom,star,end)
        inter_up_1kb_OUT.close()

	inter_down_1kb_OUT=open(options.output_prefix+".intergenic_down_1kb.txt",'w')
        for chrom,star,end in intergenic_down_1kb:
                print >>inter_down_1kb_OUT, "%s\t%s\t%s" % (chrom,star,end)
        inter_down_1kb_OUT.close()
