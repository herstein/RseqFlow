...
def process_gene_model(sh_annotation,cds_exon,intron,utr_3,utr_5):
	intergenic_up_10kb = getIntergenic(sh_annotation,direction="up",size=10000)
        intergenic_down_10kb = getIntergenic(sh_annotation,direction="down",size=10000)

        print "merge integenic region"
        #merge integenic region
        intergenic_up_10kb=unionBed3(intergenic_up_10kb)
        intergenic_down_10kb=unionBed3(intergenic_down_10kb)

        print "purify intergenic region 10kb"
        #purify intergenic region
        intergenic_up_10kb=subtractBed3(intergenic_up_10kb,cds_exon)
        intergenic_up_10kb=subtractBed3(intergenic_up_10kb,utr_5)
        intergenic_up_10kb=subtractBed3(intergenic_up_10kb,utr_3)
        intergenic_up_10kb=subtractBed3(intergenic_up_10kb,intron)
        intergenic_down_10kb=subtractBed3(intergenic_down_10kb,cds_exon)
        intergenic_down_10kb=subtractBed3(intergenic_down_10kb,utr_5)
        intergenic_down_10kb=subtractBed3(intergenic_down_10kb,utr_3)
        intergenic_down_10kb=subtractBed3(intergenic_down_10kb,intron)

	return(intergenic_up_10kb,intergenic_down_10kb)
...
def main():
	...
	print "Processing BED file Done"
        (intergenic_up_10kb,intergenic_down_10kb) = process_gene_model(sh_annotation,cds_exon,intron,utr_3,utr_5)

	inter_up_10kb_OUT=open(options.output_prefix+".intergenic_up_10kb.txt",'w')
        for chrom,star,end in intergenic_up_10kb:
                print >>inter_up_10kb_OUT, "%s\t%s\t%s" % (chrom,star,end)
        inter_up_10kb_OUT.close()

	inter_down_10kb_OUT=open(options.output_prefix+".intergenic_down_10kb.txt",'w')
        for chrom,star,end in intergenic_down_10kb:
                print >>inter_down_10kb_OUT, "%s\t%s\t%s" % (chrom,star,end)
        inter_down_10kb_OUT.close()
